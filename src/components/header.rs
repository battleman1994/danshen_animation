...
pub fn Header() -> Element {
    ...
    let badge_s = format!("background: {}; color: {}; border: 1px solid {}; border-radius: {};",
        c.badge_bg, c.badge_text, c.badge_border, c.radius_pill);
    let title_s = format!("background: {}; -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;",
        c.title_gradient);
